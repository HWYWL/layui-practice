...
public interface CommonService {
    ...
    /**
     * 设置写入配置文件的端口转发
     * @param gatewayAddresses  网关地址集合
     */
    void setPortList(List<GatewayAddress> gatewayAddresses);
     ...
     * @return
     */
    List<GatewayAddress> necessaryData(List<GatewayAddress> gatewayAddresses);
     ...
     * @param respMessage
     */
    void gitDataCombination(UserGroup userGroup, RespMessage respMessage);
}
