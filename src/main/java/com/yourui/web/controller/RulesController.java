...
public class RulesController {
    ...
    @ResponseBody
    public RespMessage fidnByRuleGroupId(Long id){
        RespMessage respMessage = new RespMessage();
        List<RulesPlus> list = new ArrayList<>();

        List<Rules> rulesList = rulesService.selectByRuleGroupId(id);
    ...
    public RespMessage save(@RequestBody Rules rules){
        ...
        if (rules.getId() == null) {
            List<Rules> fidnPort = rulesService.fidnPort(rules.getFromPort());
