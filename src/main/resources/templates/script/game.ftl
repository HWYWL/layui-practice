...
<ul class="layui-nav layui-bg-green" lay-filter="demo">
    ...
    <li class="layui-nav-item layui-this"><a href="/game">游戏</a></li>
...
<div class="center-button">
    <button class="layui-btn layui-btn layui-btn-sm" lay-submit lay-filter="addGame">
        <i class="layui-icon">&#xe608;</i>添加游戏</button>
</div>
